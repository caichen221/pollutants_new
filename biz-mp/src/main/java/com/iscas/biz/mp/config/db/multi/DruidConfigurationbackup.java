...
//
///**
// *  多数据源配置例子，如果想使用多数据源，请把{@link com.iscas.biz.mp.config.db.single.DruidConfiguration}
// *  中的@Configuration注解注释掉，请把{@link CustomDbChangeAspect}
// *  中的注解注释打开
// *
// * @author zhuquanwen
// * @vesion 1.0
