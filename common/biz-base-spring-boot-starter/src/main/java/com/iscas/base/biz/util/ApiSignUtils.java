...
public class ApiSignUtils {
    ...
    public static SortedMap<String, Object> getAllParams(HttpServletRequest request) throws IOException {
        ...
        if (!org.apache.commons.lang3.StringUtils.equalsAny(request.getMethod(), HttpMethod.GET.name(), HttpMethod.DELETE.name())) {
    ...
    public static Map<String, Object> getBodyParams(final HttpServletRequest request) throws IOException {
        ...
        //转化成json对象
        return org.apache.commons.lang3.StringUtils.isNoneBlank(wholeStr) ? jsonToMap(wholeStr.toString()) : new TreeMap<>();
    }
