package com.iscas.biz.jf.support;

import com.iscas.biz.jf.controller.BaseController;
...
public class JavaFxApplicationSupport extends Application {
    ...
    public void init() throws Exception {
        ...
        CompletableFuture.supplyAsync(() -> {
                    ...
                    return null;
//                    return SpringApplication.run(Main.class, savedArgs);
                }
    ...
    public void start(final Stage stage) throws Exception {
        ...
        if (JavaFxApplicationSupport.splashScreen.visible()) {
    ...
    private void launchApplicationView(final ConfigurableApplicationContext ctx) {
        JavaFxApplicationSupport.applicationContext = ctx;
    }
...
//            String jarModel = context.getEnvironment().getProperty("jar.model");
//            System.out.println(jarModel);
//            System.out.println(context);
//            if ("true".equals(jarModel)) {
//                context.scan("com.iscas.biz.jf");
//                for (Class component : ComponentConfig.components) {
...
//            }
    ...
    public static void launch(final Class<? extends Application> appClass,
        ...
        if (splashScreen != null) {
            JavaFxApplicationSupport.splashScreen = splashScreen;
        } else {
            JavaFxApplicationSupport.splashScreen = new SplashScreen();
        }
