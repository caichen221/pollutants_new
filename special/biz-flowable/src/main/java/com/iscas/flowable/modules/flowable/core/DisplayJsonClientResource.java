...
import com.iscas.flowable.modules.flowable.core.modelinfo.InfoMapper;
import com.iscas.flowable.modules.flowable.core.modelinfo.bpmn.ServiceTaskInfoMapper;
import com.iscas.flowable.modules.flowable.core.modelinfo.bpmn.UserTaskInfoMapper;
import com.iscas.flowable.modules.flowable.core.service.api.BaseDeploymentResourceDataResource;
 ...
 * 流程图跟踪查看功能
 * 说明：
 * 1.该类是从flowable-ui-admin-rest 项目中抽离出来的；
 * 2.流程图跟踪查看功能源码  org.flowable.ui.admin.rest.client.DisplayJsonClientResource；
 * 3.该源码还依赖的 REST在flowable-rest 项目中，org.flowable.rest.service.api.repository下 ProcessDefinitionResourceDataResource；
 * 4.modelinfo、service.api下的类均是从源码中抽离的（有的可能有修改）
 *
 * @author zhuquanwen
 * @version 1.0
...
@RestController
@RequestMapping("/app")
public class DisplayJsonClientResource extends BaseDeploymentResourceDataResource {
    ...
    public JsonNode getProcessDefinitionModelJSON(@PathVariable String processDefinitionId) {
        ...
        BpmnModel pojoModel = getBpmnModel(processDefinitionId);
        //同样的效果 为什么不用下面这个...
