package com.iscas.sso.mix.auth.util;
...
public class JWTUtils {
    private static Map<String, String> USER_TOKEN = new ConcurrentHashMap<>();
    private static Set<String> TOKENS = new HashSet<>();
    private JWTUtils(){}
    public static final String SECRET = "ISCAS-SSO-MIX-SECRET";
