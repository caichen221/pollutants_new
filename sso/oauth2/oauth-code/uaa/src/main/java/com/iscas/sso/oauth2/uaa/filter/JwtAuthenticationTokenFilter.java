package com.iscas.sso.oauth2.uaa.filter;

import com.auth0.jwt.interfaces.Claim;
import com.iscas.sso.oauth2.uaa.util.CookieUtils;
import com.iscas.sso.oauth2.uaa.util.JWTUtils;
...
//
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain) throws ServletException, IOException {
        ...
        if (authHeader == null) {
            Cookie authorization = CookieUtils.getCookieByName(request, "Authorization");
            authHeader = authorization == null ? null : authorization.getValue();
        }
