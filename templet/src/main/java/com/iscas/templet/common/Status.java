...
public enum Status {
	 ...
	 * representation in the Location column; user agents MAY use the Location column value for automatic redirection.
	...
	NOT_MODIFIED(304),
	/**
	 * The requested resource MUST be accessed through the proxy given by the Location column. The Location column
	 ...
	 * internally configurable mechanism, that an core resource is permanently unavailable and has no forwarding
