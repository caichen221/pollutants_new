...
public class JooqTestTableDao extends DAOImpl<JooqTestTableRecord, com.iscas.biz.jooq.test.code.tables.pojos.JooqTestTable, Integer> {
    ...
    public JooqTestTableDao() {
        super(JooqTestTable.JOOQ_TEST_TABLE, com.iscas.biz.jooq.test.code.tables.pojos.JooqTestTable.class);
    }
    ...
    public JooqTestTableDao(Configuration configuration) {
        super(JooqTestTable.JOOQ_TEST_TABLE, com.iscas.biz.jooq.test.code.tables.pojos.JooqTestTable.class, configuration);
    }
