...
public class CrosAutoConfiguration {
    ...
    private CorsConfiguration buildConfig() {
        ...
        corsConfiguration.addAllowedOrigin(crosProps.getOrigin());
        corsConfiguration.addAllowedHeader(crosProps.getHeaders());
        // Access-Control-Allow-Methods
        // 该字段必填。它的值是逗号分隔的一个具体的字符串或者*，表明服务器支持的所有跨域请求的方法。
        // 注意，返回的是所有支持的方法，而不单是浏览器请求的那个方法。这是为了避免多次"预检"请求。
        corsConfiguration.addAllowedMethod(crosProps.getMethods());
        ...
        corsConfiguration.setMaxAge(Long.valueOf(crosProps.getMaxage()));
        // 是否支持安全证书
        ...
        corsConfiguration.setAllowCredentials(Boolean.valueOf(crosProps.getCredentials()));
